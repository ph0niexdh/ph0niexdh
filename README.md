...
### Cybersecurity Student @ RV University, Bangalore — building intelligent systems that create impact.

Open to collaborating on AI, Cybersecurity, Full Stack & Embedded Systems projects.
...
![ChromaDB](https://img.shields.io/badge/ChromaDB-F26D21?style=flat-square)
...
![Metasploit](https://img.shields.io/badge/Metasploit-2E2E2E?style=flat-square)

---

# 🚀 Featured Projects

* 🧠 Cortex — Real-time Context-Aware AI with Persistent Memory
* 🚑 ResQPulse — AI-powered emergency response platform
...
def decode():
    text = "Khoor#Zruog"
    decoded = ''.join(chr(ord(c)-3) for c in text)
    return decoded
